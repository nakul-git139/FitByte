...
import { PullupFormAnalyzer } from './PullupFormAnalyzer';

export class PullupEngine extends BaseExerciseEngine {
  private detector: PullupDetector;
  private formAnalyzer: PullupFormAnalyzer;
  ...
  constructor() {
    super('Pullups');
    this.detector = new PullupDetector();
    this.formAnalyzer = new PullupFormAnalyzer(this.landmarkProcessor);
  }
  ...
  public processFrame(
    ...
    const formAnalysis = this.formAnalyzer.analyzeForm(
      ...
      leftElbowAngle,
      rightElbowAngle,
      this.detector.isAscendingOrTop(),
    ...
    return {
      ...
      metrics: {
        ...
        asymmetryDelta: formAnalysis.armAsymmetryDelta,
        bodySwingAngle: formAnalysis.bodySwingAngle,
